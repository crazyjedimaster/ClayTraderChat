...
io.sockets.on('connection', function (socket) {
    ...
    socket.on('sendchat', function (data, mUserID, avatar) {
        var toSend = '<div class="chat group" id = ' + id + '>' + '<div class="avatar">' + avatar + '</div>' + '<div class="content"><div class="user">' + socket.username + '</div>' + '<div class="message">' + data + '</div> </div> </div>';  
        if (today != date()) {
            //today(date)
